...
public class AppRpg extends JFrame {
    private RpgTextual RpgTextual;
    private static JLabel directionsLabel = new JLabel("Qual será o nome do personagem?");
    private static JLabel outputLabel = new JLabel();
    private static JTextField nameBox = new JTextField(25);
    private static JButton meButton = new JButton("Men");
    private static JButton comecarButton = new JButton("Começar jogo");

    public static void alternativas() throws Exception{
        App window = new App();
        window.setSize(500,500);
        window.setVisible(true);
        window.setTitle("Delta's Darkness");
        //directionsLabel.setForeground(new ColorUIResource(220, 220, 220));
        window.setLayout(new FlowLayout());//Linhas, colunas
       ...
       window.getContentPane().add(meButton);
   ...
   public static void janela()throws Exception{
        App window = new App();
        window.setSize(500,500);
        window.setVisible(true);
        window.setTitle("Delta's Darkness");
    ...
    public static JButton getcomecarButton() {
        return comecarButton;
    }

    public static void setcomecarButton(JButton comecarButton) {
        AppRpg.comecarButton = comecarButton;
    }
    
    public static JButton getmeButton(){
        reutrn meButton;
    }

    public static void setmeButton(){
        AppRpg.meButton = meButton;
    }
